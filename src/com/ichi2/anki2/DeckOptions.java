...
public class DeckOptions extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    public class DeckPreferenceHack implements SharedPreferences {
        ...
        public DeckPreferenceHack() {
            ...
            mBoolOptions.add("autoRecord");
            mBoolOptions.add("autoRecordReplay");
        ...
        protected void cacheValues() {
            ...
            try {
                ...
                mValues.put("autoRecord", Boolean.toString(mOptions.getBoolean("autoRecord")));
                mValues.put("autoRecordReplay", Boolean.toString(mOptions.getBoolean("autoRecordReplay")));
                // new
                ...
                try {
                    for (Entry<String, Object> entry : mUpdate.valueSet()) {
                        ...
                        if (mNumericOptions.containsKey(key)) {
                            ...
                            } else if (key.equals("autoRecord")) {
                                mOptions.put("autoRecord", enabled);
                            } else if (key.equals("autoRecordReplay")) {
                                mOptions.put("autoRecordReplay", enabled);
                            }
                        } else {
