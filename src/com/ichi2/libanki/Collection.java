...
import com.ichi2.anki2.AnkiDatabaseManager;
import com.ichi2.anki2.AnkiDb;
import com.ichi2.anki2.AnkiDroidApp;
import com.ichi2.anki2.Pair;
import com.ichi2.anki2.UIUtils;
                ...
                if (getModels()._availClozeOrds(model, (String) data[6], false).size() == 0) {
                    d.put("q",
                            AnkiDroidApp.getAppResources().getString(
                                    ...
                                    AnkiDroidApp.getAppResources().getString(
                                            com.ichi2.anki2.R.string.help_cloze) + "</a>"));
                }
            }
