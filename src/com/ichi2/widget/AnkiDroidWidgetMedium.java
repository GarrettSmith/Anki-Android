...
public class AnkiDroidWidgetMedium extends AppWidgetProvider {
    ...
    public static class UpdateService extends Service {
        ...
        private static final String ACTION_NEXT = "org.ichi2.anki2.AnkiDroidWidget.NEXT";

        /**
         * If this action is used when starting the service, it will move to the previous due deck.
         */
        private static final String ACTION_PREV = "org.ichi2.anki2.AnkiDroidWidget.PREV";
         ...
         */
        private static final String ACTION_IGNORE = "org.ichi2.anki2.AnkiDroidWidget.IGNORE";

        /**
         * If this action is used when starting the service, it will open the current due deck.
         */
        private static final String ACTION_OPEN = "org.ichi2.anki2.AnkiDroidWidget.OPEN";

        /**
         * Update the state of the widget.
         */
        public static final String ACTION_UPDATE = "org.ichi2.anki2.AnkiDroidWidget.UPDATE";
